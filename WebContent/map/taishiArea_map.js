...
//        }
    ...
    SetLayerRenderAttr = function () {
        ...
        findTask = new esri.tasks.FindTask("http://172.16.190.35:8399/arcgis/rest/services/basemap/csqzjxzq/MapServer");
        ...
        function showResults(results) {
            ...
            dojo.forEach(results, function (result) {
                ...
                if (record) {
                    ...
                    featureAttributes["value"] = fieldValue;
                    if (fieldValue > maxDataValue) {
                        maxDataValue = fieldValue;
                    }
                    //console.log(record.get("jyqy"), fieldValue);
                }
                var infoContent;
                switch (renderByName) {
                    case "volume":
