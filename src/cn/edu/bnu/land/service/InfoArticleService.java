...
import cn.edu.bnu.land.common.AndroidListener;
	...
	public Map<String, Object> listInfoArticle(String start, String limit,
		...
		//搜索日期不为空，搜索关键词不为空
			...
			String hql2 = " and ( infoArticle.articleName like '%"+searchKeyword+"%'"+
					...
					" or infoArticle.isMailpush like '%"+searchKeyword+"%'"+
					" or infoArticle.isSmspush like '%"+searchKeyword+"%'"+
...
//	}
	...
	public List<InfoArticle> getArticleListAllForHome(int i) {
		String hql = "from InfoArticle as infoArticle where channelId="
				+ i+" and articleIsrecycle ='否' and articleIsdraft ='否' order by infoArticle.articleId desc";
		System.out.println(hql);		
		List<InfoArticle> results = null;
		System.out.println("this.sessionFactory:  "+sessionFactory);
