...
/**
 * Home object for domain model class PublishDynamic.
 * @see cn.edu.bnu.land.model.PublishDynamic
 * @author Hibernate Tools
 */
public class PublishDynamicHome {

	private static final Log log = LogFactory.getLog(PublishDynamicHome.class);
	...
	public void persist(PublishDynamic transientInstance) {
		log.debug("persisting PublishDynamic instance");
		try {
	...
	public PublishDynamic merge(PublishDynamic detachedInstance) {
		...
		try {
			PublishDynamic result = (PublishDynamic) sessionFactory
	...
	public PublishDynamic findById(java.lang.Integer id) {
		log.debug("getting PublishDynamic instance with id: " + id);
		try {
			PublishDynamic instance = (PublishDynamic) sessionFactory
					.getCurrentSession().get(
							"cn.edu.bnu.land.model.PublishDynamic", id);
			if (instance == null) {
	...
	public List findByExample(PublishDynamic instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("cn.edu.bnu.land.model.PublishDynamic")
