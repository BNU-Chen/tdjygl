 ...
 */
@Repository
public class CrawlurlHome {

	private static final Log log = LogFactory.getLog(CrawlurlHome.class);
	...
	public void find(Crawlurl landquota) {
...
//		session.createSQLQuery(transinfo.getArea());
	...
	public List findByExample(Crawlurl instance) {
	...
	public List<Crawlurl> selecturl(){		
		System.out.print("爬虫Home_before");
		String hql="from Crawlurl as Crawlurl";
	    List<Crawlurl> results=null;
	    try{
	    	org.hibernate.Query query=sessionFactory.getCurrentSession().createQuery(hql);
	    	results=query.list();
	    	for(Crawlurl crawlurl:results){
	    		System.out.println(crawlurl.getNumber()+ crawlurl.getWebname());
	    	}	    
	    }
		catch(Exception e){
			e.printStackTrace();
